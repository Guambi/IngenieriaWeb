...
Cloud.setup({
  ...
  "customerlogin":{"verb":"PUT","url":"/api/v1/customer/entrance/login","args":["emailAddress","password","rememberMe"]},
  ...
  //CoreForms
  "createLocal":{"verb":"POST","url":"/admin/locales","args":["nombre","corriente"]},
  "editLocal":{"verb":"PUT","url":"/admin/locales","args":["nombre","corriente"]},
  "createTransaccion":{"verb":"POST","url":"/admin/transaccion","args":["descripcion","valor","tarjeta","cuenta","local","cuota"]},
  "createCliente":{"verb":"POST","url":"/admin/cuentas","args":["email","password","nombre","cedula","edad","trabajo","casa"]},
  "hacerPago":{"verb":"POST","url":"/customer/pagos","args":["id","monto"]},
  "solicitud":{"verb":"POST","url":"/customer/solicitud","args":["transaccion","cuotas"]},
  }
  /* eslint-enable */
